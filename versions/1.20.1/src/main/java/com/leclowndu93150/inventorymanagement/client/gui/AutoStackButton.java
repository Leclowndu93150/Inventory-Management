...
public class AutoStackButton extends InventoryManagementButton {
    private static final ResourceLocation TEXTURE_FROM = new ResourceLocation(InventoryManagementMod.MOD_ID, "textures/gui/stack_from.png");
    private static final ResourceLocation TEXTURE_FROM_HIGHLIGHTED = new ResourceLocation(InventoryManagementMod.MOD_ID, "textures/gui/stack_from_highlighted.png");
    private static final ResourceLocation TEXTURE_TO = new ResourceLocation(InventoryManagementMod.MOD_ID, "textures/gui/stack_to.png");
    private static final ResourceLocation TEXTURE_TO_HIGHLIGHTED = new ResourceLocation(InventoryManagementMod.MOD_ID, "textures/gui/stack_to_highlighted.png");
