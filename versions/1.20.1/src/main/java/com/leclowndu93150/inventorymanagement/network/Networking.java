...
public final class Networking {
    ...
    public static class SortC2SPacket {
        ...
        public SortC2SPacket(boolean isPlayerInventory, boolean includeHotbar) {
        ...
        public static void encode(SortC2SPacket packet, FriendlyByteBuf buf) {
            ...
            buf.writeBoolean(packet.includeHotbar);
        }

        public static SortC2SPacket decode(FriendlyByteBuf buf) {
            return new SortC2SPacket(buf.readBoolean(), buf.readBoolean());
        }
