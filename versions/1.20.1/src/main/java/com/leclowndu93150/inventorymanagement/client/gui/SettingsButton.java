...
public class SettingsButton extends InventoryManagementButton {
    private static final ResourceLocation TEXTURE = new ResourceLocation(InventoryManagementMod.MOD_ID, "textures/gui/settings.png");
    private static final ResourceLocation TEXTURE_HIGHLIGHTED = new ResourceLocation(InventoryManagementMod.MOD_ID, "textures/gui/settings_highlighted.png");
