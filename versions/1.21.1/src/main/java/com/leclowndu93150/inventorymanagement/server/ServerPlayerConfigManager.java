...
public class ServerPlayerConfigManager {
    ...
    public void updatePlayerConfig(ServerPlayer player, Networking.PlayerConfigSyncC2S packet) {
        PlayerConfigData data = new PlayerConfigData(
                packet.modEnabled(),
                packet.showSort(),
                packet.showTransfer(),
                packet.showStack(),
                packet.showSettingsButton(),
                packet.sortingMode(),
                packet.autoRefillEnabled(),
                packet.autoRefillFromShulkers(),
                packet.ignoreHotbarInTransfer(),
                packet.enableDynamicDetection(),
                packet.minSlotsForDetection(),
                packet.slotAcceptanceThreshold()
        );
